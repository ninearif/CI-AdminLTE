...
?>
            <header class="main-header">
                <a href="<?php echo site_url('admin/dashboard'); ?>" class="logo">
                    <span class="logo-mini"><b>e</b><?php echo $title_mini; ?></span>
                    <span class="logo-lg"><b>E</b><?php echo $title_lg; ?></span>
                </a>
...
<?php if ($admin_prefs['user_menu'] == TRUE): ?>
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<?php echo base_url($avatar_dir . '/man.png'); ?>" class="user-image" alt="User Image">
                                    <span class="hidden-xs"><?php echo $user_login['username']; ?></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li class="user-header">
                                        <img src="<?php echo base_url($avatar_dir . '/man.png'); ?>" class="img-circle" alt="User Image">
